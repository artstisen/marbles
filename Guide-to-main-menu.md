...
[^1]: The **Transfer** option on **menu page 3** will retain the collected entries in memory for the current session or until discarded through the Transfer options.
...
- Press ```CTRL+W``` +
  ...
  - ```P``` **Color preset**: Cycle the 6 color presets (see **menu page 4** for customizing color schemes).
...
- Press ```CTRL+W``` +
  ...
  - ```E``` to **Reset**: Revert to default colors of the selected color scheme (selected on **menu page 3**)
